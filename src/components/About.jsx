        ...
        <div className='flex flex-col md:flex-row items-center justify-between gap-10'>
          <div ref={textRef} className='md:w-1/2 glass-panel p-8'>
            ...
            <p className='mb-4 text-white/80'>
              I'm a self-taught software junkie with a passion for
              full-stack development across Web2 and Web3 ecosystems. Based
              in Nigeria, I've been crafting digital experiences that blend
              creativity with technical precision in both traditional and
              blockchain technologies.
            </p>
            <p className='mb-6 text-white/80'>
              My journey in tech has been driven by curiosity and a
              relentless pursuit of knowledge, constantly exploring the
              intersection of conventional web development and
            ...
            <div className='flex space-x-4'>
              ...
              <a
                href='#projects'
                className='cyber-button bg-transparent border-neon-green text-neon-green shadow-neon-green hover:bg-neon-green'
              >
                View Work
              </a>
            </div>
          ...
          <div ref={imageRef} className='md:w-2/5'>
            <div className='relative'>
              ...
              <div className='w-full aspect-square bg-space-navy rounded-lg overflow-hidden neon-border relative'>
                <div className='absolute inset-0 flex items-center justify-center'>
                  <Icon
                    ...
                    className='text-neon-blue w-full h-full'
                  />
                </div>
              ...
              <div
                className='absolute top-1/4 -right-8 glass-panel p-3 animate-float'
                style={{ animationDelay: "1s" }}
              >
                <Icon icon='logos:javascript' width='24' height='24' />
              </div>
              <div
                className='absolute -bottom-6 left-1/4 glass-panel p-3 animate-float'
