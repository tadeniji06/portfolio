...
const ProjectCard = ({
	...
	return (
		...
		>
			...
			<div className='relative h-48 overflow-hidden'>
				...
				>
					{image ? (
						...
						<Icon
							icon='mdi:web'
							className='text-neon-blue text-6xl'
						/>
					)}
				</div>
			...
			{/* Project Info */}
			<div className='p-6'>
				<h3 className='text-xl font-bold mb-2 text-neon-green'>
					{title}
				</h3>
	...
	const projects = [
		{
			...
			description:
				"Website for a Real Estate & Consulting Firm in Kenya",
		...
		},
		{
			title: "Awo Tech Mall",
			description:
				"Realtor, RealEstate and TechMall all in one, ikeja, Lagos",
			technologies: ["React", "Tailwind CSS", "Framer-motion"],
			image: null,
